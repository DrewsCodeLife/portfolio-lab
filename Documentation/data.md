...
SPY, VTI, EFA, VXUS, BND, VNQ, RWR, and BIL:
  - Were originally collected from: [Kaggle Huge Stock Market Dataset](https://www.kaggle.com/datasets/borismarjanovic/price-volume-data-for-all-us-stocks-etfs?resource=download)
  - Were later collected from: [Alpha Vantage](https://www.alphavantage.co/)
